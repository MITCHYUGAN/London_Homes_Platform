...
import { Mail, Phone, MapPin, ArrowRight, Instagram, Facebook, Linkedin, ShieldCheck, Check } from 'lucide-react';
  ...
  return (
    ...
    <footer id="main-footer" className="bg-[#111111] text-white pt-24 pb-12 border-t border-[#622219]/20 font-sans">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 pb-20 border-b border-[#333333]">
        ...
        <div id="footer-brand" className="space-y-6">
          ...
          >
            <span className="text-2xl font-bold tracking-widest text-white uppercase hover:text-[#99B7DE] transition-colors">
              London Homes
            </span>
            <span className="text-[10px] font-medium uppercase tracking-[0.25em] text-[#99B7DE] mt-1">
            ...
            {[
              ...
              <li key={link.id}>
                <button
                  ...
                  className="text-gray-400 hover:text-white text-sm transition-colors focus:outline-none cursor-pointer"
                >
                  {link.label}
                </button>
              </li>
        ...
        <div id="footer-newsletter" className="space-y-6">
          ...
          <p className="text-gray-400 text-sm leading-relaxed">
            Subscribe to our private list for quarterly Lagos off-plan opportunities and legal title updates.
          </p>
          <form onSubmit={handleSubscribe} className="space-y-3">
            <div className="relative">
              ...
              <button
                type="submit"
                className="absolute right-2 top-1/2 -translate-y-1/2 text-[#99B7DE] hover:text-white transition-colors cursor-pointer"
      ...
      <div id="footer-bottom-grid" className="max-w-[1440px] mx-auto px-6 lg:px-12 pt-12 grid grid-cols-1 lg:grid-cols-3 gap-8 text-gray-400 text-sm">
        ...
        <div className="flex items-start space-x-3">
          ...
          <span>
            <strong>Inquiries:</strong> +234 (0) 803 123 4567 | +234 (0) 805 999 8888 <br />
        ...
        <div className="lg:text-right space-y-1">
          ...
          <p className="text-xs text-gray-600">
            Certified Member: Real Estate Developers Association of Nigeria (REDAN) & Lagos State Real Estate Regulatory Authority (LASRERA).
          </p>
        </div>
      </div>
    </footer>
    ...
    <div id="live-status-bar" className="border-t border-[#ECECEC] flex flex-col md:flex-row items-center justify-between px-6 lg:px-12 py-4 bg-white z-10 text-gray-900 font-sans gap-4 md:gap-0">
      ...
      <div className="flex gap-6 items-center text-[10px] uppercase tracking-widest">
        ...
        <a href="#" className="font-bold text-gray-900 hover:text-[#622219] transition-colors">Instagram</a>
        <a href="#" className="font-bold text-gray-900 hover:text-[#622219] transition-colors">LinkedIn</a>
        <a href="https://wa.me/2348031234567" target="_blank" rel="noreferrer" className="font-bold text-[#D11D1F] hover:text-[#622219] transition-colors">WhatsApp</a>
      </div>
    </div>
  </>
  );
